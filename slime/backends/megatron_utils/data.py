...
def get_batch(
    ...
    if multimodal_train_inputs is not None:
        ...
        # until this per-micro-batch collation, then move to GPU together.
        # Avoids pre-loading all images into GPU memory at once (critical
        # for multi-turn envs where num_samples >> num_episodes).
